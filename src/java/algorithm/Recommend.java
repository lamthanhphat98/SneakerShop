...
public class Recommend {
    ...
    public static HashMap<String, Double> recommendShop(String[] listSearch) throws SQLException, NamingException {
        SneakerDAO dao = new SneakerDAO();
        HashMap<String, Double> hashMap = new HashMap<>();
        hashMap = dao.recommendShoes(listSearch, hashMap);
        return hashMap;
    }

    public static String processingHash(String[] listSearch) throws SQLException, NamingException {
