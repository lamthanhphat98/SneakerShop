        ...
        <div id="background">
            <div id="page">
                ...
                <div id="contents">
                    <div class="footer">
                        ...
                        <ul class="items" id="product_search">
                            <c:set var="result" value="${requestScope.SEARCHLIST}" />
                ...
                <script>
                    ...
                    page.innerHTML += '<a href="#">' + '&laquo;' + '</a>';
                    page.innerHTML += '<a href="MainController?action=Search&txtSearch=${requestScope.SEARCH}&page=1" class="active">1</a>';
                    for (var i = 2; i <= ${sessionScope.PAGE}; i++) {
                        page.innerHTML += '<a href="#" onclick="movePage(' + i + ')">' + i + '</a>'
                        if (i === ${sessionScope.PAGE})
                        {
                            page.innerHTML += '<a href="#" onclick="movePage(' + i + ')">' + '&raquo;' + '</a>'
                        }
                    }
                    page.innerHTML += '<a href="#">&raquo;</a>'
                </script>
                <script>
